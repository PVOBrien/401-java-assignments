...
public class App {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            Gson gson2 = new Gson();
            RecentQuotes quotes2 = new RecentQuotes("Charles Dickens", "Hello?");
            Reader quoteReader2 = Files.newBufferedReader(Paths.get("src/main/resources/recentQuotes.json"));
            RecentQuotes[] numQuotes2 = gson2.fromJson(quoteReader2, RecentQuotes[].class);
            System.out.println(quotes2.stringify(getRandomNumber(0, 138), numQuotes2));
